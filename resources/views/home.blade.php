  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container">
      ...
      <div class="logo float-left">
        <h1 class="text-light"><a href="index.html"><span><img src="{{ asset('assets/img/logo-ugm2.png') }}"><br>UGM</span></a></h1>
      ...
      <nav class="nav-menu float-right d-none d-lg-block">
        <ul>
          ...
          <li><a href="services.html">Birokrasi</a></li>
          <li><a href="portfolio.html">DPM UF</a></li>
          <li><a href="team.html">KEGIATAN KAMI</a></li>
          <li><a href="blog.html">ASPIRASI</a></li>
          <li class="drop-down"><a href="">UUPEMIRA</a>
            <ul>
